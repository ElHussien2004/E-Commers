...
{
    /// <inheritdoc />
    public partial class Orderentitymigration : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "DeliveryMotheds",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DeliveryMotheds", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_orders_DeliveryMotheds_DeliveryMethodId",
                        column: x => x.DeliveryMethodId,
                        principalTable: "DeliveryMotheds",
                        principalColumn: "Id",
